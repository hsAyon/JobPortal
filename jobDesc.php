    ...
    <table align="center" width="1000px" style="padding: 50px; color: black; font-family: Verdana;">
        ...
        <tr>
            <td width=700px>
                <table>
                    <tr>
                        <td width="128px" height="128px" style="padding-right: 20px;"><img src="image/job_logo_1.jpg" alt="N/A" style="display: block; width: 100%; height: 100%;"></td>
                    ...
                    <tr>
                        <?php
                        $splitres = explode(',',$row['candidates']);
                        $candidatescount = count($splitres);
                        ?>
                        <td colspan="2" style="padding-top:25px;">Applyied candidates (<?php echo $candidatescount-1 ?>): <?php

                        $i=0;
                        while($i<$candidatescount-1){

                                $splitres[$i] = explode(';',$splitres[$i]);
                                $i++;

                        }
                        $x=0;
                        //var_dump($splitres);
                        while($x<$candidatescount-1){
                            echo $splitres[$x][0] . "; ";
                            $x++;
                        }
