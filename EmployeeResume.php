...
$sqlUserCheck = "SELECT email,cgpa,name,title,aboutMe,gender,facebook,linkedin,twitter,google,address,city,phone,website,age,salary,experience FROM seekerinfo WHERE email  = '$email'";
...
<body ">
  ...
  <div class="profile" style="padding-top: 3%">
    <div class="profilePicture">
      <img class="profile-light-image" src="image/index.jpg" alt="" width="169" height="169">
    </div>
    ...
    <div class="social">
      <ul>
        <li><a class="social-icon" target="_blank" href="<?php echo $facebook ?>"><i class="fab fa-facebook-f fa-lg"></i></a></li>
        <li><a class="social-icon" target="_blank" href="<?php echo $linkedn ?>"><i class="fab circle fa-linkedin-in fa-lg"></i></a></li>
        <li><a class="social-icon" target="_blank" href="<?php echo $twitter ?>"><i class="fa circle fa-twitter twitter fa-lg"></i></a></li>
        <li><a class="social-icon" target="_blank" href="<?php echo $google ?>"><i class="fa circle fa-google-plus google fa-lg"></i></a></li>

      </ul>
    </div>

    <div class="cv">
      <a href="#" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Download CV</a>
    </div>
  </div>
  ...
  <div class="personalInfo_div" style="display: flex">
    <div class="personalInfo">
      <div class="aboutMe">
        ...
        <hr>
        <p class="text-style-1" style="font-size: 14px"> <?php echo $aboutMe ?> </p>
      </div>
      ...
      <div class="professionalSkill">
        ...
        <hr>
        <div class="proskill" id="proskill">
              ...
              <div class="pskill-1" style="margin-right: 25px;">
                <article class="progress-linear progress-bar-secondary animated" style="display: flex">
                  ...
                  <div class="progress" style="background-color: #9a9191; width:75%">
                    <div class="progress-bar progress-bar-warning progress-bar-striped" role="progressbar" style="width: <?php echo $r[1] ?>%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><?php echo $r[1] ?>%</div>
                  </div>
                </article>
