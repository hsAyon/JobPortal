...
//{*/	///MySQL Query of Job Search result
	...
	if (strpos($salar, "<") && strpos($exp, "<")) {
		...
		/*echo $salar2[1];
		echo $exp2[1];*/
		$commentsQuery = "SELECT ID,employer,title,location,salary,type FROM job WHERE location='$location' AND type='$type' AND salary <='$salar2[1]' AND catagory='$catagory' AND experience <='$exp2[1]' limit 3";
	...
	elseif (strpos($salar, "<") && strpos($exp, "-")) {
		...
		/*echo $salar2[1];
		echo $exp2[1];*/
		$commentsQuery = "SELECT ID,employer,title,location,salary,type FROM job WHERE location='$location' AND type='$type' AND salary <='$salar2[1]' AND catagory='$catagory' AND experience BETWEEN '$exp2[0]' AND '$exp2[1]' limit 3";
		$result = mysqli_query($conn, $commentsQuery);
	} 
	elseif (strpos($salar, "<") && strpos($exp, ">")) {
		$salar2 = explode('<', $salar);
	...
	elseif (strpos($salar, "-") && strpos($exp, "<")) {
		...
		echo $salar2[1];
		echo $exp2[1];*/
		$commentsQuery = "SELECT ID,employer,title,location,salary,type FROM job WHERE location='$location' AND type='$type' AND salary BETWEEN '$salar2[0]' AND '$salar2[1]' AND catagory='$catagory' AND experience <='$exp2[1]' limit 3";
		$result = mysqli_query($conn, $commentsQuery);
	} 
	elseif (strpos($salar, "-") && strpos($exp, "-")) {
		$salar2 = explode('-', $salar);
		...
		echo $salar2[1];
		echo $exp2[1];*/
		$commentsQuery = "SELECT ID,employer,title,location,salary,type FROM job WHERE location='$location' AND type='$type' AND salary BETWEEN '$salar2[0]' AND '$salar2[1]' AND catagory='$catagory' AND experience BETWEEN '$exp2[0]' AND '$exp2[1]' limit 3";
		$result = mysqli_query($conn, $commentsQuery);
	} 
	elseif (strpos($salar, "-") && strpos($exp, ">")) {
		$salar2 = explode('-', $salar);
...
//{*/ //MySQL Query of Job Search result
	if (strpos($salar, "<") && strpos($exp, "<")) {
		...
		/*echo $salar2[1];
		echo $exp2[1];*/
		$commentsQuery = "SELECT ID,employer,title,location,salary,type FROM job WHERE location='$location' AND type='$type' AND salary <='$salar2[1]' AND catagory='$catagory' AND experience <='$exp2[1]' limit $stv, 3";
		$result = mysqli_query($conn, $commentsQuery);
	} 
	elseif (strpos($salar, "<") && strpos($exp, "-")) {
		$salar2 = explode('<', $salar);
		...
		/*echo $salar2[1];
		echo $exp2[1];*/
		$commentsQuery = "SELECT ID,employer,title,location,salary,type FROM job WHERE location='$location' AND type='$type' AND salary <='$salar2[1]' AND catagory='$catagory' AND experience BETWEEN '$exp2[0]' AND '$exp2[1]' limit $stv, 3";
		$result = mysqli_query($conn, $commentsQuery);
	} 
	elseif (strpos($salar, "<") && strpos($exp, ">")) {
		$salar2 = explode('<', $salar);
	...
	elseif (strpos($salar, "-") && strpos($exp, "<")) {
		...
		echo $salar2[1];
		echo $exp2[1];*/
		$commentsQuery = "SELECT ID,employer,title,location,salary,type FROM job WHERE location='$location' AND type='$type' AND salary BETWEEN '$salar2[0]' AND '$salar2[1]' AND catagory='$catagory' AND experience <='$exp2[1]' limit $stv, 3";
		$result = mysqli_query($conn, $commentsQuery);
	} 
	elseif (strpos($salar, "-") && strpos($exp, "-")) {
		$salar2 = explode('-', $salar);
		...
		echo $salar2[1];
		echo $exp2[1];*/
		$commentsQuery = "SELECT ID,employer,title,location,salary,type FROM job WHERE location='$location' AND type='$type' AND salary BETWEEN '$salar2[0]' AND '$salar2[1]' AND catagory='$catagory' AND experience BETWEEN '$exp2[0]' AND '$exp2[1]' limit $stv, 3";
		$result = mysqli_query($conn, $commentsQuery);
	} 
	elseif (strpos($salar, "-") && strpos($exp, ">")) {
		$salar2 = explode('-', $salar);
