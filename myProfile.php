        ...
        <div class="candidate-single-profile-info">
          <div class="single-resume-feild resume-avatar">
            <div class="resume-image">
              <img src="image/index.jpg" alt="resume avatar">
            ...
            <div class="resume-box">
              ...
              <div class="single-resume-feild feild-flex-2">
                ...
                <div class="single-input">
                  ...
                  <input type="text" value="<?php echo $age ?>" id="age">
                </div>
              </div>
              <div class="single-resume-feild feild-flex-2">
                <div class="single-input">
                  <label for="Salary">cgpa :</label>
                  <input type="text" value="<?php echo $cgpa ?>" id="cgpa" name="cgpa">
                </div>
                <div class="single-input">
                  <label for="Expected"> Expected Salary:</label>
                  <input type="text" value="<?php echo $salary ?>" id="salary" name="salary">
                </div>
              </div>
              <div class="single-resume-feild feild-flex-2">
                <div class="single-input">
                  <label for="Salary">Experience :</label>
                  <input type="text" value="<?php echo $experience ?>" id="exp" name="exp">
                </div>
                <div class="single-input">
            ...
            <div class="resume-box">
              ...
              <div class="single-resume-feild feild-flex-2">
                <div class="single-input">
                  ...
                  <input type="text" value="<?php echo $phone ?>" id="phone">
                </div>
                <div class="single-input">
            ...
            <div class="resume-box">
              ...
              <div class="single-resume-feild feild-flex-2">
                <div class="single-input">
                  ...
                  <input type="text" value="<?php echo $twitter ?>" id="twitter" name="twitter">
                </div>
                <div class="single-input">
                  <label for="twitter">
                  ...
                  <input type="text" value="<?php echo $facebook ?>" id="facebook" name="facebook">
                </div>
              </div>
              <div class="single-resume-feild feild-flex-2">
                <div class="single-input">
                  ...
                  <input type="text" value="<?php echo $google ?>" id="google" name="google">
                </div>
                <div class="single-input">
                  <label for="linkedin">
                  ...
                  <input type="text" value="<?php echo $linkedn ?>" id="linkedn" name="twitter">
                </div>
              </div>
            </div>
